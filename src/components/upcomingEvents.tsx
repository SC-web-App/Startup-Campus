export const UpcomingEvents = () => {
    return(
        ...
        <div className="text-center text-sm mt-12"> What do we have in store? 
        <div className="text-center text-2xl font-bold ">Upcoming Events</div>
        <div className="text-center text-l ">Take a glance at the events and workshops we have planned</div>
