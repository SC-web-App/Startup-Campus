        ...
        <div className="text-center p-8">
            ...
            <div className="flex flex-wrap justify-center gap-8">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 w-80 text-center ">
                    <div className="p-4 w-1/4 m-auto rounded-full bg-green-100">
                        <img
                            src="/Launch-img/plug.png"
                        />
                    </div>
                    <div className="text-2xl font-bold text-gray-800 mb-2">Building Connections</div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 w-80 text-center ">
                    <div className="p-4 w-1/4 m-auto rounded-full bg-blue-100">
                        <img
                            src="/Launch-img/progress.jpg"
                        />
                    </div>
                    <div className="text-2xl font-bold text-gray-800 mb-2">Enhancing Skills</div>
                    <p className="text-gray-600">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 w-80 text-center ">
                    <div className="p-4 w-1/4 m-auto rounded-full bg-yellow-100">
                        <img
                            src="/Launch-img/lock.jpg"
                        />
                    </div>
                    <div className="text-2xl font-bold text-gray-800 mb-2">Unlocking Opportunities</div>
                    <p className="text-gray-600">
